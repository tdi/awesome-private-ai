...
- [ENZO](https://github.com/theguysudo/ENZO) - Self-hosted BYOK AI workspace: chat, agents, and skills (Gmail, Calendar, project generation) running entirely on the user's own provider API keys, with no middleman service and keys sealed client-side with AES-256-GCM.
