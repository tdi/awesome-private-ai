...
- [Agent QA](https://github.com/vostride/agent-qa) - Open-source self-improving QA agent for web and mobile testing, with local and open-source model support through OpenAI- and Anthropic-compatible endpoints.
