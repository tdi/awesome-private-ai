...
- [Locally Uncensored](https://github.com/PurpleDoubleD/locally-uncensored) - Privacy-first desktop app (Tauri + React) for local AI chat via Ollama and image/video generation via ComfyUI. Runs entirely offline with no data leaving your machine.
